...
export function buildVmField(field: Field, fieldUI: FieldUI, formValues:FormValues, formCompute:Compute, readOnly:boolean): VmField {
    let vmField:new (field:Field, ui:FieldUI, formValues:FormValues, formCompute:Compute, readOnly:boolean) => VmField;
    /*
    switch (fieldUI.type) {
