import { VBand, VmFieldBand, VmArrBand, VmFieldsBand, VmSubmitBand } from "./vBand";
...
import { VField, buildVmField, VComputeField } from "./vField";
...
export class BandsBuilder {
    ...
    private vmFieldFromField(field:Field): VField {
    ...
    private vmFieldFromUI(fieldUI:FieldUI):VField {
        return;
    }

    private vmArrFromUI(arrBandUI:ArrBandUI):VArr {
        return;
    }
}
