...
export declare class CUsq extends Controller implements Usq {
    ...
    getSheet(entityName: string): Sheet;
    getAction(entityName: string): Action;
    getQuery(entityName: string): Query;
    getBook(entityName: string): Book;
    getMap(entityName: string): Map;
    getHistory(entityName: string): History;
    getPending(entityName: string): Pending;
    getTuid(entityName: string): TuidMain;
