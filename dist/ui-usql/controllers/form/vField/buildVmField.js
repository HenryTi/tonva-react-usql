import { VmIntField, VmDecField, VmStringField, VmTextField, VmDateTimeField } from './vField';
export function buildVmField(field, fieldUI, formValues, formCompute, readOnly) {
    let vmField;
    /*
    switch (fieldUI.type) {
